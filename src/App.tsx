...
function App() {
  ...
  const atualizarDados = (dados: Dados, nomeCidade: string) => {
    ...
    setIncendios(isApiError(dados.incendios) ? null : dados.incendios); // Corrigido aqui também
    setPrevisao(isApiError(dados.previsao) ? null : dados.previsao); // Corrigido aqui também
